...
export default function DashboardShortcutCard({
  ...
  return (
    <Link
      href={href}
      className="group block rounded-2xl bg-white px-6 py-7 shadow-[0_14px_36px_rgba(15,23,42,0.1)] ring-1 ring-slate-200/70 transition hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(15,23,42,0.12)] focus:outline-none focus:ring-2 focus:ring-[#0b9887] focus:ring-offset-2 sm:px-8"
    >
